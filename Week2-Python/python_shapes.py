...
#def draw_square(size, color):
   ...
   # penup()
   # forward(side_length + 30)
   # pendown()



#draw_square(side_length, "yellow") <-- this makes the squares
#draw_square(side_length, "red")
#draw_square(side_length, "blue")
speed(50)
penup()
goto(-200,0)
...
for i in range(30):        
    draw_polygon(7, side_length, "red")
penup()
goto(-200,0)
for i in range(30):        
    draw_polygon(10, side_length, "green")
penup()
goto(-200,0)
for i in range(30):        
    draw_polygon(12, side_length-20, "blue")
penup()
goto(-200,0)
for i in range(30):        
    draw_polygon(5, side_length/2, "yellow")
penup()
goto(-200,0)
for i in range(40):        
    draw_polygon(3, side_length-70, "purple")
